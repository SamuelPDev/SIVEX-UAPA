...
const ManageVoluntariado: React.FC = () => {
  ...
  const filtered = useMemo(
    () =>
      items
        .filter((p) => p.category === "Voluntariado")
        .filter((p) =>
              ...
              <tbody>
                {currentItems.map((p) => (
                  <tr key={p.id}>
                    ...
                    <td>
                      <Link
                        to={`/editar-proyectos/voluntariado/${p.id}`}
...
export default ManageVoluntariado;